...
min_delete_size = float('inf')
available_space = 70000000 - home_folder.get_size()
required_space = 30000000 - available_space
for folder in folders:
    folder_size = folder.get_size()
    if folder_size == required_space:
        min_delete_size = folder_size
        break
    elif folder_size > required_space:
        min_delete_size = min(folder_size, min_delete_size)

print(min_delete_size)